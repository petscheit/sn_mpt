...
class CairoRunner:
    ...
    def compile_cairo_file(self):
        while True:
            ...
            return_code = os.system(
                f"cairo-compile --cairo_path='packages/eth_essentials' {self.filename_dot_cairo_path} --output {compiled_path}"
            )
    ...
    def construct_run_command(self, compiled_path):
        cmd_base = f"cairo-run --program={compiled_path} --layout=recursive_with_poseidon"
        input_flag = (
